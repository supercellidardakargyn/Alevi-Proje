...
export class AuthService {
  ...
  private async issueSession(user: { id: string; displayName: string; bio: string | null; avatarUrl: string | null; city: string | null; createdAt: Date }, metadata: { userAgent?: string; ipAddress?: string }) {
