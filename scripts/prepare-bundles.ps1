...
$setupSrc = Join-Root 'site/indir/CanMeydani-Kurulum-0.5.4.exe'
if (Test-Path -LiteralPath $setupSrc) {
  Copy-Item -LiteralPath $setupSrc -Destination (Join-Root 'dist/CanMeydani-Kurulum-0.5.4.exe') -Force
}
